        ...
        <div class="max-w-md w-full space-y-8 relative z-10">
            ...
            <div class="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl">
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-600">Masuk ke akun DEDY KOST Anda</p>
                </div>
                ...
                @if (session('status'))
                    <div
                        class="bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 rounded-xl p-4 mb-6 shadow-md animate-slideDown">
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                ...
                <form class="space-y-6" action="/login" method="POST">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}" class="font-medium text-cyan-600 hover:text-cyan-700">
                                Lupa password?
                            </a>
                        </div>
                    </div>
                    ...
                    <button type="submit"
                        class="w-full py-3 px-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all transform hover:scale-105 shadow-lg shadow-cyan-500/30">
                        Masuk
                    </button>
                </form>
                ...
                <div class="mt-6 space-y-3">
                    <p class="text-center text-sm text-slate-600">
                        Belum punya akun?
                        <a href="/register" class="font-medium text-cyan-600 hover:text-cyan-700">
                            Daftar sekarang
                        </a>
                    </p>
                    <p class="text-center text-sm text-slate-600">
                        Masuk sebagai Admin?
                        <a href="/admin/login" class="font-medium text-cyan-600 hover:text-cyan-700">
                            Login Admin
                        </a>
                    </p>
                </div>
