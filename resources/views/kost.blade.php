...
@section('content')
    ...
    {{-- Hero Section --}}
    <section class="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900">
        ...
        <div class="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center items-center text-center pt-20">
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
                Temukan Kamar<br>
                <span class="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Impian Anda</span>
            </h1>

            <p class="text-xl md:text-2xl text-slate-300 mb-10 max-w-3xl mx-auto font-light">
                Kamar kost nyaman dengan fasilitas lengkap di lokasi strategis. Mulai dari Rp 120k/Malam.
            </p>

            <div class="flex flex-col sm:flex-row gap-4">
                <a href="#rooms" class="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white rounded-full font-semibold text-lg transition-all transform hover:scale-105 shadow-xl shadow-cyan-500/30">
            ...
            <div class="grid grid-cols-3 gap-8 mt-16 max-w-2xl mx-auto">
                <div class="text-center">
                    <div class="text-4xl font-bold text-cyan-400 mb-2">{{ $rooms->count() }}</div>
                    <div class="text-slate-400 text-sm uppercase tracking-wide">Kamar Tersedia</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-cyan-400 mb-2">{{ $rooms->count() }}</div>
                ...
                <div class="text-center">
                    ...
                    <div class="text-slate-400 text-sm uppercase tracking-wide">Keamanan</div>
                </div>
            </div>
        </div>
    ...
    <div id="rooms" class="bg-white py-20">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <span class="text-cyan-600 font-semibold uppercase tracking-wider text-sm">Pilihan Terbaik</span>
                <h2 class="text-4xl md:text-5xl font-bold text-slate-900 mb-4 mt-2">Pilihan Kamar</h2>
                <p class="text-slate-600 text-lg max-w-2xl mx-auto">Temukan kamar yang sesuai dengan kebutuhan Anda</p>
            </div>
                ...
                foreach($rooms as $r) {
                    ...
                    foreach($imgs as $img) {
                        ...
                        if (!in_array($originalName, $seenFiles)) {
                            ...
                            $allImages->push(['url' => Storage::url($img->jalur_foto), 'name' => $r->namakamar ?? 'Unit']);
                        }
                    }
                }
            ...
            @else
                <div class="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <p class="text-slate-500 max-w-md mx-auto">Saat ini belum ada kamar kost yang tersedia untuk disewa. Silakan cek kembali nanti.</p>
                </div>
            @endif
        </div>
    </div>
